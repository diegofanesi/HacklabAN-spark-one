            ...
            , addPane = function (pane, force) {
                ...
                switch (pane) {
                    case "north":
                        ...
                        break;
                    case "south":
                        CSS.bottom = sC.insetBottom;
                        CSS.left = sC.insetLeft;
                        CSS.right = sC.insetRight;
                        break;
                    case "west":
                        CSS.left = sC.insetLeft; // top, bottom & height set by sizeMidPanes()
                        break;
                    case "east":
                        CSS.right = sC.insetRight; // ditto
                        break;
                ...
                var resizePanes = function (evt, ui, pane, resizingDone, masks) {
                    ...
                    switch (pane) {
                        ...
                        case "west":
                            ...
                            break;
                        case "south":
                            resizerPos = sC.offsetHeight - dragPos.top - o.spacing_open;
                            break;
                        case "east":
                            resizerPos = sC.offsetWidth - dragPos.left - o.spacing_open;
                            break;
                    }
                    ;
